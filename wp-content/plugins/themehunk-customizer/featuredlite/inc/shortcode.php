...
<div class="container">
 ...
 <?php if(get_theme_mod( 'prlx_opn_new_tab')==''){?>
        <a href="<?php echo get_theme_mod( 'parallax_button_link','#'); ?>" class="page-scroll"><button><?php echo get_theme_mod( 'parallax_button_text',__('Buy Now','featuredlite')); ?></button></a>
  <?php } else { ?>
