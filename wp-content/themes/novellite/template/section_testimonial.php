                ...
                <div class="col-md-12">
                    <div class="testimonial-inner animated bottom-to-top">
                        ...
                        <ul class="bxslider">
                            ...
                            <li>
                                <img src="<?php if (get_theme_mod('third_author_image','') != '') { ?><?php echo esc_url(get_theme_mod('third_author_image','')); } else { echo get_template_directory_uri(); ?>/images/testimonial-image.png <?php } ?>" onMouseOver="javascript: this.title='';" title="<a class='arrow'></a>
                                <?php echo get_theme_mod('third_author_desc',''); ?>
